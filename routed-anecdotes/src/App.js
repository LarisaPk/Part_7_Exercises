...
const App = () => {
  ...
  const vote = (id) => {
    ...
    setNotification(`You voted for ${voted.content} !`)
    setTimeout(() => setNotification(``), 10000)
  }
  ...
  return (
    <div>
      ...
      <Router>
          ...
          <Route exact path="/" render={() => <AnecdoteList anecdotes={anecdotes} vote={vote}/>} />
          <Route exact path="/anecdotes" render={() => <AnecdoteList anecdotes={anecdotes} vote={vote}/>} />
